...
By default, the SDK starts sending signals immediately. If you need to defer events:
...
void Awake()
{
    SDK.OnBackendConnected += data => Debug.Log("Connected to Wavedash!");
    SDK.OnBackendDisconnected += data => Debug.Log("Disconnected from Wavedash");
    SDK.OnBackendReconnecting += data => Debug.Log("Reconnecting...");
}
```
...
public class WavedashManager : MonoBehaviour
{
    void Awake()
    {
        SDK.OnBackendConnected += HandleConnected;
        SDK.OnBackendDisconnected += HandleDisconnected;
    }
    ...
    void HandleConnected(Dictionary<string, object> data)
    {
        Debug.Log("Connected to Wavedash!");
    }

    void HandleDisconnected(Dictionary<string, object> data)
    {
