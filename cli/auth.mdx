...
<AccordionGroup>
  ...
  <Accordion title="Port already in use">
    The CLI automatically finds an available port starting at 7777. If all ports are in use, close other applications or wait a moment and try again.
  </Accordion>
  <Accordion title="Connection issues">
    Ensure your firewall allows outbound connections to wavedash.com.
  </Accordion>
