...
<Warning>
The first run of `wavedash dev` requires **sudo privileges** to install the certificate into your system's trust store. You will be prompted for your password.
